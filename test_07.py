...
class D(unittest.TestCase):
    ...
    def test_004bianji(self):
        try:
            ...
            self.huohu.find_element_by_name("pro_name").send_keys("0oojm")
            self.huohu.find_element_by_name("cpbh").send_keys("N00007998")
            self.huohu.find_element_by_name("cptxm").send_keys("AAe76g9Hp284")
...
if __name__ == '__main__':
    ...
    suite.addTest(D("test_004bianji"))
