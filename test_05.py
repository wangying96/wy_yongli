...
class D(unittest.TestCase):
    ...
    def test_02xinzeng(self):
        try:
            ...
            self.huohu.find_element_by_name("pro_name").send_keys("陕西酥梨")
            self.huohu.find_element_by_name("cpbh").send_keys("N00utyuy10")
            self.huohu.find_element_by_name("cptxm").send_keys("HU7689Hutyuy3284")
...
if __name__ == '__main__':
    ...
    suite.addTest(D("test_02xinzeng"))
